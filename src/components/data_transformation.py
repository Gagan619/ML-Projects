...
class DataTransformation:
    ...
    def get_data_tranformer_object(self):
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                ...
                #StandardScaler is used to bring all the values in a range
                # OneHotEncoder is used for forming new column for categorical vaules
                # imputer handles the missing values
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            # Saving the preprocessor file as pkl file
            save_object(
